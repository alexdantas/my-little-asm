// Simulator - Implements instructions assembled by my `assembler`.
//
...
// Here we have machine definitions.
// We simulate a hardware that would execute our instructions.

// Supported memory size (2^16 16-bit words).
...
int main(int argc, char* argv[])
{
	...
	if (argc < 2)
	{
		Log::error("simulador: fatal error: no input files\n"
		           "\n"
